...
r_hotplace = APIRouter(
    prefix="/api/hotplace",
    tags=["hotplace"]
)

# 핫플레이스 게시글 리스트 요청 (가까운 순)
@r_hotplace.post("/list/default")
